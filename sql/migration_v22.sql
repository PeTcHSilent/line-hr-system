-- ══════════════════════════════════════════════════════════════
-- Migration v22: ระบบปรับเงินเดือนประจำปี (Salary Adjustment)
-- รัน: psql $DATABASE_URL -f sql/migration_v22.sql
-- ══════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS salary_adjustments (
  ...
  round_name       VARCHAR(100),               -- ชื่อรอบการขึ้น เช่น "ประจำปี 2569"
